...
static const char col_purple[]      = "#bd93f9";//Dracula
...
static const char *fox[]  = { "firefox-esr", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Return, movestack,      {.i = +1 } },
